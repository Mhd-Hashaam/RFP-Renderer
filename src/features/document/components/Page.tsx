...
export function Page({
  ...
  return (
    <article className="overflow-hidden rounded-2xl border border-zinc-800 bg-zinc-900 shadow-2xl transition-shadow duration-300 hover:shadow-[0_16px_48px_rgba(0,0,0,0.6)]">
      {/* Page content */}
